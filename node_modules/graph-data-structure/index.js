...
function Graph(serialized) {
    ...
    function addEdge(u, v, givenBuses, weight) {
        addNode(u);
        addNode(v);
        var x = new Array();
        x.push(v);
        ...
        let pos = adjacent(u).indexOf(x);
        for(let i of givenBuses){
            adjacent(u)[pos].push(i);
        }

        //console.log(u + " " + adjacent(u) + "\n");
    ...
    function shortestPath(source, destination) {
        ...
        function path() {
            ...
            */
            ...
            // dest node node ... node source
            //source node ... node node dest

            // Lipman Hall "--EE,F,RexB,RexL-->" Red Oak
            //   node            string             node

            //Edge[source][index of destination] = buses that lead to destination || where index != 0
